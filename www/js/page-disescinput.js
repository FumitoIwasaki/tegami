app.controller('SubController7',['$scope','$rootScope','INQUIRE','Authenticator', function($scope, $rootScope, INQUIRE, Authenticator) {

// *****************************************************************************
// 最寄現場検索をクリックした場合の処理
// *****************************************************************************
  $scope.sarchJob = function() {
    loadingModal.show();
...
// 現場リストをクリックしたときの処理
// *****************************************************************************
  $scope.escItemSelect = function(index) {
    var selectItem = $scope.negenbas[index];
    document.SendData4.torokuno.value = selectItem.TOROKU;
  }
...
// 次へをクリックしたときの処理
// *****************************************************************************
  $scope.torokuInput2 = function(tmpStr) {
    var tmpStr2 = '';
    if (tmpStr == '1') {
