...
app.controller('SubController1',['$scope','$rootScope','INQUIRE','FJ01sql','Authenticator', function($scope, $rootScope, INQUIRE,FJ01sql, Authenticator) {
...
// *****************************************************************************
  ...
  .catch(function(error) {
    ...
    ons.notification.alert({ title: "test", message: "test" });
